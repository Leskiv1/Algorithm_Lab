import unittest
from src.find_the_smallest_unsorted_subarray_in_array import find_unsort_arr
...
class MyTestCase(unittest.TestCase):
    ...
    def test_different_array(self):
        ...
        self.assertEqual(find_unsort_arr(array1), (3, 8))
        self.assertEqual(find_unsort_arr(array2), (2, 6))
